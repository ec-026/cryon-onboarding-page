    ...
    React.useCallback(() => {
      const onBackPress = () => {
        if (navigation.isFocused()) {
          return true; // Disable back functionality only for FanDashboard screen
        }
...
const FanDashboard: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { marginBottom: headerMarginBottom }]}>
        <Text style={styles.welcomeText}>Welcome to the Fan Dashboard!</Text>
      </View>
      <View>
